...
class DynamicFormWidget extends \yii\base\Widget
{
  ...
  protected function initOptions()
  {
    ...
    $this->_options['copyButton'] = $this->copyButton;
  ...
  public function registerAssets($view)
  {
    ...
    // add a click handler for the copy button
    if (!empty($this->copyButton)) {
      $js = 'jQuery("#' . $this->formId . '").on("click", "' . $this->copyButton . '", function(e) {' . "\n";
      $js .= "    e.preventDefault();\n";
      $js .= '    jQuery(".' . $this->widgetContainer . '").triggerHandler("beforeCopy", [jQuery(this)]);' . "\n";
      $js .= '    jQuery(".' . $this->widgetContainer . '").yiiDynamicForm("copyItem", ' . $this->_hashVar . ", e, jQuery(this));\n";
      $js .= "});\n";
      $view->registerJs($js, $view::POS_READY);
    }
